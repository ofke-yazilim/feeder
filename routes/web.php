...
Route::get('/profile', [\App\Http\Controllers\Auth\UserController::class,'show'])->name('web.show')->middleware('auth.feeder');
...
Route::get('/twit/list', [\App\Http\Controllers\TwitListController::class,'index'])->name('web.twit.index')->middleware('auth.feeder');
Route::get('/get/twits', [\App\Http\Controllers\TwitListController::class,'get_twits'])->name('web.twit.get')->middleware('auth.feeder');
Route::get('/twit/edit/{id}', [\App\Http\Controllers\TwitListController::class,'edit'])->name('web.twit.edit')->middleware('auth.feeder');
Route::post('/twit/update/{id}', [\App\Http\Controllers\TwitListController::class,'update'])->name('web.twit.update')->middleware('auth.feeder');
